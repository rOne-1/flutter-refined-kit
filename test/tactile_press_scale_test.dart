...
import 'package:flutter_refined_kit/physics/tactile_press_scale.dart';

void main() {
  group('PressableScale', () {
    testWidgets('uses a quick press-in duration and the house spring release duration/curve',
        (tester) async {
    ...
    testWidgets('exposes a button semantic role, respecting enabled/disabled state',
        (tester) async {
