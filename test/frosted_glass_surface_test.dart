...
import 'package:flutter_refined_kit/ui/frosted_glass_surface.dart';

void main() {
  group('FrostedGlassSurface', () {
    testWidgets('renders child content with minimal required params', (tester) async {
    ...
    testWidgets('applies outerShadow and innerHighlightColor when supplied', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: FrostedGlassSurface(
              ...
              borderColor: Colors.white24,
              outerShadow: const [
                BoxShadow(color: Colors.black, blurRadius: 20, offset: Offset(0, 8)),
              ],
    ...
    testWidgets('defaults render without error and with no visible outer shadow',
        (tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(
